...
function init(){
	...
	$.ajax({ 
		url: urlcore + "/api/index/channelCountByAdmin?gmtDatetime="+gmtDatetime+"&id="+id,
		type: "get",
		dataType: 'json',
		...
		success:function(data){
			if (data.success == true) {
				...
				$('#channelCount2').text(data.data.channelCount2 == null ? 0 : data.data.channelCount2);
				$('#channelCount3').text(data.data.channelCount3 == null ? 0 : data.data.channelCount3);
				$('#channelCount4').text(data.data.channelCount4 == null ? 0 : data.data.channelCount4);
