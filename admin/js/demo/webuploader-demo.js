jQuery(function() {
    ...
    uploader = WebUploader.create({
        ...
        server: urlcore + '/file/upload/batch',
        fileVal:'files',
        fileNumLimit: 300,
    ...
    uploader.on( 'uploadSuccess', function(files,response) {
        ...
        var uploadSuccessImgUrl;
        for (var i = arr.length - 1; i >= 0; i--) {
            uploadSuccessImgUrl = arr[i];
        }
        var strHtml = 
            	'<div style="position:relative;width:250px;height:250px;float:left;" display="block">'+
            	'	<span style="position:absolute;top:10px;right:10px;font-size:20px;color:#f00;" class="glyphicon glyphicon-trash" aria-hidden="true">'+
            	'	</span>'+
            	'	<img style="padding: 5px 5px 5px 5px;" width="250px" height="250px" src="'+value+'">'+
        		'</div>';
        $('#uploadSuccessImg').append(strHtml);
    });
